...
export default function Footer() {
  return (
    <footer className="bg-charcoal text-luxury-white">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-stone-gray text-sm leading-relaxed mb-6">
              Elevated essentials for modern kitchens and baths. Designed to bring clarity, beauty,
              and function into everyday spaces.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-stone-gray hover:text-brand-green transition-colors"
            ...
            <ul className="space-y-2">
              {footerLinks.shop.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-stone-gray hover:text-brand-green transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-stone-gray">
          <p>&copy; {new Date().getFullYear()} Kitchen & Bath Society. All rights reserved.</p>
